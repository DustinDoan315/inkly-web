...
export default function SupportPage() {
  return <LegalLayout eyebrow="We&apos;re here to help" title="Inkly Support" updated="August 31, 2026">
    ...
    <h3>How do I delete my account?</h3><p>Delete it inside the app: <strong>Profile → Delete Account</strong>. Read more about what is removed on the <a href="/delete-account">account deletion page</a>.</p>
  </LegalLayout>;
}
